...
fun main() {
    val isTodaySunWeather = true
    val isOpenTheAwning = true
    val airHumidity = 20
    val timeOfYear = "зима"

    println("Благоприятные ли условия сейчас для роста бобовых? ${isTodaySunWeather && isOpenTheAwning && airHumidity == 20 && timeOfYear != "зима"}")
